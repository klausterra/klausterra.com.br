export function CircuitBackground() {
  return (
    <div className="circuit-bg" aria-hidden="true">
      ...
      >
        <defs>
          <linearGradient id="signal-beam" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="var(--signal)" stopOpacity="0" />
            <stop offset="50%" stopColor="var(--signal)" stopOpacity="0.8" />
            <stop offset="100%" stopColor="#ffffff" stopOpacity="1" />
          </linearGradient>
          <linearGradient id="ochre-beam" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="var(--ochre)" stopOpacity="0" />
            <stop offset="50%" stopColor="var(--ochre)" stopOpacity="0.8" />
            <stop offset="100%" stopColor="#ffffff" stopOpacity="1" />
          </linearGradient>
        </defs>

        {/* Trilhas laterais esquerdas (linhas ortogonais e a 45 graus) */}
        ...
        {/* Trilha horizontal discreta no topo */}
        <path
        ...
        {/* Pacotes de dados / pulsos luminosos circulando pelas trilhas */}
